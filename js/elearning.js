...
(function($){
	...
	var methods = {
		...
		mostrarPerfil: function () {
			TweenLite.to( $("#barra-perfil"), 0.7, { css:{ top:"0px", opacity: 1}, ease:Circ.easeInOut,
				onComplete: function () {
		...
		ocultarPerfil: function () {
			TweenLite.to($("#barra-perfil"), 0.7, {css:{top: "-70px", opacity: 0}, ease:Circ.easeInOut,
				onComplete: function () {
		...
		showSeccion : function(index) {
			...
			TweenLite.to( slides.eq(currentIndex), 0.7, {css:{left:index > currentIndex ? -opcionesDefecto.widthSlide : opcionesDefecto.widthSlide,opacity:1}, ease:Circ.easeInOut,
